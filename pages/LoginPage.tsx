...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-indigo-500 via-sky-500 to-purple-600 p-6">
      {showIntro && (
        <Modal isOpen={showIntro} onClose={() => {}} title="" hideCloseButton>
          <div className="p-8 bg-black/50 backdrop-blur-md rounded-2xl">
            <IntroAnimation />
            <div className="mt-8 text-center">
              <p className="text-white mb-4">ยินดีต้อนรับสู่แผงควบคุม</p>
              <Button onClick={handleIntroFinish} className="bg-blue-500 hover:bg-blue-600">
                เข้าสู่ระบบ
              </Button>
            </div>
          </div>
